...
\author{
  \IEEEauthorblockN{Jay Salot and Jinal Sasiya}
  \IEEEauthorblockA{\textit{MSc. Data Science}\\
  \textit{Dhirubhai Ambani University}\\
  Gandhinagar, India \\
  202518029@dau.ac.in, 202518062@dau.ac.in}
  \and
  \IEEEauthorblockN{Advisor: Srimanta Mandal}
  \IEEEauthorblockA{\textit{PhD (Computing and Electrical Engineering)}\\
  \textit{IIT Mandi}\\
  srimanta\_mandal@dau.ac.in}
}
\maketitle
